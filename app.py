...
6. **Away goals** — if a two-legged tie is level on aggregate, the team with more away goals advances. If away goals are also level, Game will go to penalty shootouts without extratime as the game itslef doesnt have 2 legged ties and tracking the results from previous ties becomes a problem.""")
